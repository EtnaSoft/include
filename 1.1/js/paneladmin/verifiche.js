...
app.controller('AdminVerifiche', function($rootScope, $scope, $http, ListAdmin) {
    ...
    $scope.elimina = function(position){
        ...
        $http({ method: "POST", url: urlFUNCTION+"delete.php" ,data: {idType: $scope.list.items[position].id, type: $scope.postData.typeView} , headers: {'Content-Type': 'application/x-www-form-urlencoded'} })
